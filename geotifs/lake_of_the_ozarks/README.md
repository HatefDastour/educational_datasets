...
- **No Data Value**: Varies by dataset
...
with rasterio.open('srtm_30m_composite.tif') as src:
    elevation = src.read(1)
    
# Read Landsat RGB composite
with rasterio.open('landsat9_rgb_composite.tif') as src:
...
axes[0].set_title('SRTM Elevation')
axes[1].imshow(rgb)
axes[1].set_title('Landsat 9 RGB Composite')
plt.show()
```
